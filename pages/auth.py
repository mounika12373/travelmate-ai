...
from utils.auth_utils import login_user, hash_password, verify_password
        ...
        if submit_reset:
            if not forgot_email:
                ...
                if user:
                    ...
                    st.info("Simulation mode: Clicking this button confirms the account exists. Reset token has been dispatched.")
                else:
